...
func (cp *ControlPlane) DeepCopyInto(out *ControlPlane) {
	*out = *cp
	out.TypeMeta = cp.TypeMeta
	cp.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = cp.Spec
	cp.Status.DeepCopyInto(&out.Status)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControlPlane.
func (cp *ControlPlane) DeepCopy() *ControlPlane {
	if cp == nil {
		return nil
	}
...
func (cp *ControlPlane) DeepCopyObject() runtime.Object {
	if c := cp.DeepCopy(); c != nil {
		return c
	}
	return nil
}
