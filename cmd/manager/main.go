...
import (
	...
	"github.com/eclipse-iofog/iofog-operator/v2/pkg/apis"
	"github.com/eclipse-iofog/iofog-operator/v2/pkg/controller"
...
func main() {
	...
	err = leader.Become(context.TODO(), "iofog-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
